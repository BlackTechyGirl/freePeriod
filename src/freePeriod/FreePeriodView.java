...
public class FreePeriodView {
    public static void main(String[] args) {
        try {
            ...
            List<LocalDate> nonFertileDates = MenstralCycleDates.getNonFertileDates(lastPeriodDate, cycleLength);

            StringBuilder strings = new StringBuilder();
            strings.append("Your next period date is: ").append(flowDates.get(0)).append("\n");
            strings.append("Your flow starts on: ").append(flowDates.get(1)).append("\n");
            strings.append("Your flow ends on: ").append(flowDates.get(flowDates.size() - 1)).append("\n");
